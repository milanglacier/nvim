...
keymap('n', '<Leader><Tab>1', notify 'workbench.action.openEditorAtIndex1', opts_desc 'tab: 1st tab')
keymap('n', '<Leader><Tab>2', notify 'workbench.action.openEditorAtIndex2', opts_desc 'tab: 2nd tab')
keymap('n', '<Leader><Tab>3', notify 'workbench.action.openEditorAtIndex3', opts_desc 'tab: 3rd tab')
keymap('n', '<Leader><Tab>4', notify 'workbench.action.openEditorAtIndex4', opts_desc 'tab: 4st tab')
keymap('n', '<Leader><Tab>5', notify 'workbench.action.openEditorAtIndex5', opts_desc 'tab: 5st tab')
keymap('n', '<Leader><Tab>6', notify 'workbench.action.openEditorAtIndex6', opts_desc 'tab: 6st tab')
keymap('n', '<Leader><Tab>7', notify 'workbench.action.openEditorAtIndex7', opts_desc 'tab: 7st tab')
keymap('n', '<Leader><Tab>8', notify 'workbench.action.openEditorAtIndex8', opts_desc 'tab: 8st tab')
keymap('n', '<Leader><Tab>9', notify 'workbench.action.openEditorAtIndex9', opts_desc 'tab: 9st tab')
