...
local function get_word_and_sentence_under_point()
    vim.cmd [[normal! "wyiw]]
    vim.cmd [[normal! "syis]]
end
...
-- registers [a-z],
-- so this function may overwrites those macros.
local function get_visual_region_and_sentenec_under_point()
    vim.cmd [[normal! "syis]]
    vim.cmd [[normal! gv"ry]]
end

command('GetWordAndSentenceUnderPoint', get_word_and_sentence_under_point, {})
command('GetVisualRegionAndSentenceUnderPoint', get_visual_region_and_sentenec_under_point, {})
